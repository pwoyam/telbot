"""
لایه‌ی واسط برای هوش مصنوعی
از AI_PROVIDER در config.py استفاده می‌کند تا بین OpenAI، Anthropic
یا هر reseller سازگار با OpenAI (مثل سرویس‌های ایرانی) سوییچ کند.
"""
...
# حافظه‌ی ساده‌ی مکالمه در حافظه
